...
export const VoiceEventType = {
  ...
  QUOTA_EXCEEDED: 'voice:quota_exceeded',
...
export enum AuditAction {
  ...
  QUESTION_BANK_QUESTION_CREATED = 'QUESTION_BANK_QUESTION_CREATED',
  QUESTION_BANK_QUESTION_UPDATED = 'QUESTION_BANK_QUESTION_UPDATED',
  QUESTION_BANK_QUESTION_SUBMITTED_REVIEW = 'QUESTION_BANK_QUESTION_SUBMITTED_REVIEW',
  QUESTION_BANK_QUESTION_REVIEWED = 'QUESTION_BANK_QUESTION_REVIEWED',
  QUESTION_BANK_QUESTION_PUBLISHED = 'QUESTION_BANK_QUESTION_PUBLISHED',
  QUESTION_BANK_QUESTION_ARCHIVED = 'QUESTION_BANK_QUESTION_ARCHIVED',
  QUESTION_BANK_ANSWER_REVEALED = 'QUESTION_BANK_ANSWER_REVEALED',
  QUESTION_BANK_BOOKMARK_ADDED = 'QUESTION_BANK_BOOKMARK_ADDED',
  QUESTION_BANK_BOOKMARK_REMOVED = 'QUESTION_BANK_BOOKMARK_REMOVED',
  QUESTION_BANK_FEEDBACK_SUBMITTED = 'QUESTION_BANK_FEEDBACK_SUBMITTED',
}
...
export enum ErrorCode {
  ...
  QUESTION_BANK_NOT_FOUND = 'QUESTION_BANK_NOT_FOUND',
  QUESTION_BANK_ANSWER_UNAVAILABLE = 'QUESTION_BANK_ANSWER_UNAVAILABLE',
  QUESTION_BANK_ENTITLEMENT_REQUIRED = 'QUESTION_BANK_ENTITLEMENT_REQUIRED',
  QUESTION_BANK_QUOTA_EXHAUSTED = 'QUESTION_BANK_QUOTA_EXHAUSTED',
  CONTENT_NOT_REVIEWED = 'CONTENT_NOT_REVIEWED',
  QUESTION_BANK_INVALID_TRANSITION = 'QUESTION_BANK_INVALID_TRANSITION',
  QUESTION_BANK_REVIEWER_EQUALS_AUTHOR = 'QUESTION_BANK_REVIEWER_EQUALS_AUTHOR',
...
export enum MentorAuthorityState {
  PENDING = 'PENDING',
  APPROVED = 'APPROVED',
  SUSPENDED = 'SUSPENDED',
  REVOKED = 'REVOKED',
...
export enum QuestionAnswerAuthority {
  CANONICAL = 'CANONICAL',
  REFERENCE = 'REFERENCE',
  FRAMEWORK = 'FRAMEWORK',
}

export enum QuestionFeedbackReason {
...
export enum QuestionFeedbackStatus {
  PENDING = 'PENDING',
  REVIEWED = 'REVIEWED',
  RESOLVED = 'RESOLVED',
  DISMISSED = 'DISMISSED',
...
export enum ArenaActionEventType {
  ...
  FINAL_SUBMISSION_CREATED = 'FINAL_SUBMISSION_CREATED',
}

export enum ArenaAiAssistanceMode {
  DISABLED = 'DISABLED',
...
export enum ArenaSandboxMode {
  STAGE_A_MOCK = 'STAGE_A_MOCK',
