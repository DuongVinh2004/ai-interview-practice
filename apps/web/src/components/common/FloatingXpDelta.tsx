...
export function FloatingXpDelta({
  amount,
  reason,
  onDone,
  className = '',
}: FloatingXpDeltaProps) {
  ...
  return (
    ...
    >
      <Sparkles className="h-3.5 w-3.5 text-amber-900 fill-amber-900 animate-spin" style={{ animationDuration: '3s' }} />
      <span>+{amount} XP</span>
