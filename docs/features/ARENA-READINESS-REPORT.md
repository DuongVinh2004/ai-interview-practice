...
| **Challenge Manifest Engine** | _None_                                                 | No manifest loader, validation engine, or tarball unbundler      | **MISSING**              | H    | To be built in Phase P2 (`apps/api/src/modules/engineering-arena/manifest/`).                                                |
| **Workspace Runtime Sandbox** | _None_                                                 | No isolated multi-file ephemeral container runner                | **MISSING**              | H    | To be built in Phase P3 (`apps/api/src/modules/engineering-arena/runtime/`).                                                 |
