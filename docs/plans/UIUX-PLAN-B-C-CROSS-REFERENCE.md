...
- **[ĐÃ TRÙNG KHỚP / HOÀN THIỆN FRONTEND] B3 — Voice Pipeline UI**:
  ...
  - *Chưa làm*: Backend server WebSocket kết nối trực tiếp Deepgram và ElevenLabs.
- **[BỔ TRỢ SẴN] B1 — Cloud Storage UI**:
  ...
  - *Chưa làm*: Backend endpoint `/storage/presign-upload` và tích hợp AWS S3/Cloudflare R2 SDK.
- **[BỔ TRỢ SẴN] B4 — Payment UI**:
  ...
  - *Chưa làm*: Backend PayOS SDK và Stripe Live webhook signing.
...
- **[TRÙNG KHỚP NỀN TẢNG — 70%] C2 — Sensory Polish & Micro-Interactions**:
  ...
  - *Chưa làm*: Hiệu ứng âm thanh click/level-up (Howler.js) và pháo hoa ăn mừng (Canvas-confetti).
- **[TRÙNG KHỚP NỀN TẢNG — 60%] C4 — Offline Resilience & Mobile**:
  ...
  - *Chưa làm*: `manifest.json`, Service Worker caching tĩnh thông qua `vite-plugin-pwa`.
- **[BỔ TRỢ GIAO DIỆN — 50%] C1 — Gamification Display**:
  ...
  - *Chưa làm*: Schema `user_xp`, backend API cộng điểm XP theo thời gian thực.
